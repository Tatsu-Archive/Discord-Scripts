...
$DiscordPtb = Get-Process -Name "DiscordPtb" -ErrorAction SilentlyContinue
if ($DiscordPtb){$Version = "DiscordPtb"}
...
if ($Version){
    ...
    Write-Output "Discord was not detected on your computer, launch Discord and re-launch this script"
    }
